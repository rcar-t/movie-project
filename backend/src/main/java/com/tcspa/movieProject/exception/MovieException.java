...
import com.tcspa.movieProject.config.MessagesConfig;
...
public class MovieException {
	...
	@Autowired
	public MovieException(MessagesConfig messagesConfig) {
		MovieException.messagesConfig = messagesConfig;
	}
	...
	private static String format(String template, String ... args) {
		Optional<String> templateContent = Optional.ofNullable(messagesConfig.getConfigValue(template));
